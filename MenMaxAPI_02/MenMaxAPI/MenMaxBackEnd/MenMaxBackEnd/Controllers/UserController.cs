...
//            {
//                Id = userFind.Id,
//                LoginType = userFind.LoginType, // Assuming LoginType exists in User entity
//                Role = userFind.Role,
//                Password = Encoding.UTF8.GetString(Convert.FromBase64String(userFind.Password)), // Return decoded password as per original logic
//                UserName = userFind.UserName, // Assuming UserName exists in User entity
//                Avatar = userFind.Avatar, // Assuming Avatar exists in User entity
//                Email = userFind.Email, // Assuming Email exists in User entity
//                PhoneNumber = userFind.PhoneNumber, // Assuming PhoneNumber exists in User entity
//                address = null, // Assuming Address exists in User entity
//                Carts = userFind.Carts, // Assuming Carts exists in User entity
//                Orders = userFind.Orders // Assuming Orders exists in User entity
//            };
