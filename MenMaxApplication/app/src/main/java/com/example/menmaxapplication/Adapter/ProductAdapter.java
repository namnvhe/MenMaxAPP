...
import com.example.menmaxapplication.Model.Cart;
import com.example.menmaxapplication.Model.Product;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
    ...
    public ProductAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_viewholder, parent, false);
