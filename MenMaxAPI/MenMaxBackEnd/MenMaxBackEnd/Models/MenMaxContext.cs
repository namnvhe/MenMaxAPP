...
public partial class MenMaxContext : DbContext
{
  ...
  #warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
          => optionsBuilder.UseSqlServer("Server=DESKTOP-TSP54U7;uid=sa;pwd=123;database=MenMax;TrustServerCertificate=True;");
  */
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__cart__3213E83FC642D287");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__category__3213E83F3484F4F9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__order__3213E83F575FE4B8");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__order_it__3213E83FDDC7BA66");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__product__3213E83FFC0721DC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__product___3213E83F7885D7C4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__user__3213E83FB07CA8B9");
